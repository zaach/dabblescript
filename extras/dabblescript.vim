" Vim syntax file
" Language:     DabbleScript
" Maintainer:   Zachary Carter <https://github.com/jelera>
...
syntax keyword javaScriptMessage	console alert confirm prompt status
...
syntax keyword dabbleOperatorDecl    infixl infixr prefix postfix assign
syntax keyword dabbleKeyword         deleteop
...
if version >= 508 || !exists("did_dabblescript_syn_inits")
  if version < 508
    let did_dabblescript_syn_inits = 1
  ...
  HiLink dabbleOperatorDecl             Special
  HiLink dabbleKeyword                  Identifier
...
let b:current_syntax = "dabblescript"
if main_syntax == 'dabblescript'
  unlet main_syntax
endif
